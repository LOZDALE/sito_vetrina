...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.__tsParticlesInternals = global.__tsParticlesInternals || {}, global.__tsParticlesInternals.presets = global.__tsParticlesInternals.presets || {}, global.__tsParticlesInternals.presets.snow = global.__tsParticlesInternals.presets.snow || {})));
    ...
    const sides = 12, maxAngle$1 = 360, minAngle = 0;
    class CircleDrawer {
        draw(data) {
            drawCircle(data);
        }
    ...
    async function loadSnowfallPalette(engine) {
        await engine.pluginManager.register(e => {
            e.pluginManager.addPalette(paletteName, options$1);
        });
    }
...
Object.assign(globalThis.window || globalThis, { loadSnowPreset: (globalThis.__tsParticlesInternals.presets.snow || {}).loadSnowPreset });
