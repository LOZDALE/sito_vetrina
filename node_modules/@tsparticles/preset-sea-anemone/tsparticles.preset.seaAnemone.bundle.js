...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.__tsParticlesInternals = global.__tsParticlesInternals || {}, global.__tsParticlesInternals.presets = global.__tsParticlesInternals.presets || {}, global.__tsParticlesInternals.presets.seaAnemone = global.__tsParticlesInternals.presets.seaAnemone || {})));
                ...
                if (this._shape) {
                    ...
                    if (shapePosData) {
                        ...
                        if (replaceData.color && shapePosData.color) {
                            setParticlesOptionsFillColor(particlesOptions, shapePosData.color, replaceData.opacity ? (shapePosData.opacity ?? defaultOpacity$1) : defaultOpacity$1, true);
                        }
                    }
                    else {
                        position = null;
...
Object.assign(globalThis.window || globalThis, { loadSeaAnemonePreset: (globalThis.__tsParticlesInternals.presets.seaAnemone || {}).loadSeaAnemonePreset });
