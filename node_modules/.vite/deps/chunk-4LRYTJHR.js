...
var PluginManager = class {
  constructor(engine) {
    ...
    __publicField(this, "_allLoadersSet", /* @__PURE__ */ new Set());
    __publicField(this, "_configs", /* @__PURE__ */ new Map());
    __publicField(this, "_engine");
    __publicField(this, "_executedSet", /* @__PURE__ */ new Set());
    __publicField(this, "_initialized", false);
    __publicField(this, "_isRunningLoaders", false);
    __publicField(this, "_loadPromises", /* @__PURE__ */ new Set());
    this._engine = engine;
  }
  get configs() {
    const res = {};
  ...
  async init() {
    ...
    this._executedSet = /* @__PURE__ */ new Set();
...
var Engine = class {
  constructor() {
    ...
    __publicField(this, "_domArray", []);
    __publicField(this, "_eventDispatcher", new EventDispatcher());
    __publicField(this, "_initialized", false);
  }
  get items() {
  ...
  async load(params) {
    ...
    const { Container } = await import("./Container-QVT4LAC3.js"), id = params.id ?? (domSourceElement == null ? void 0 : domSourceElement.id) ?? `tsparticles${Math.floor(getRandom() * loadRandomFactor).toString()}`, { index, url } = params, options = url ? await getDataFromUrl({ fallback: params.options, url, index }) : params.options, currentOptions = itemFromSingleOrMultiple(options, index), { items } = this, oldIndex = items.findIndex((v) => v.id.description === id), newItem = new Container({
...
//# sourceMappingURL=chunk-4LRYTJHR.js.map
