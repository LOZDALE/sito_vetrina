...
var MovePluginInstance = class {
  ...
  async _init() {
    var _a, _b;
    const availablePathGenerators = await ((_b = (_a = this._pluginManager).getPathGenerators) == null ? void 0 : _b.call(_a, this._container, true));
...
//# sourceMappingURL=MovePluginInstance-CDE3BYDI.js.map
