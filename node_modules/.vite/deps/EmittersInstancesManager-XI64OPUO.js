...
var EmittersInstancesManager = class {
  ...
  async addEmitter(container, options, position) {
    ...
    const { EmitterInstance } = await import("./EmitterInstance-CPMOZV4Z.js"), emitter = new EmitterInstance(this._pluginManager, container, (emitter2) => {
...
//# sourceMappingURL=EmittersInstancesManager-XI64OPUO.js.map
