...
var PoissonDisc = class {
  ...
  _getNewPoint(currentPoint, tries) {
    ...
    for (let i = -1; i <= maxNeighbourIndex; i++) {
      for (let j = -1; j <= maxNeighbourIndex; j++) {
        ...
        const neighbourCellValue = (_a = this.grid[neighbourGrid.y]) == null ? void 0 : _a[neighbourGrid.x];
        if (neighbourCellValue === void 0 || neighbourCellValue < gridMinValue) {
          continue;
        }
  ...
  _step() {
    ...
    for (let tries = 0; tries < this.retries; tries++) {
      ...
      if (randomActivePointIndex === void 0) {
        continue;
      }
...
//# sourceMappingURL=PoissonDisc-LCBDI7QV.js.map
